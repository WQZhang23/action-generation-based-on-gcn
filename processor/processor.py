...
class Processor(IO):
    ...
    def get_parser(add_help=False):
        ...
        parser.add_argument('--generator', default=None, help='the model will be used')
        parser.add_argument('--gen_args', action=DictAction, default=dict(), help='the arguments of generator')
        parser.add_argument('--discriminator', default=None, help='the model will be used')
        parser.add_argument('--dis_args', action=DictAction, default=dict(), help='the arguments of discriminator')
